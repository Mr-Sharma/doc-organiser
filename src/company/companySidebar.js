...
class CompanySidebar extends Component {
  ...
  componentDidMount = () => {
    ...
    this.setState({userData:data, username: data.username || 'Company'});
  }
  render() {
    return (
          ...
          <div className="left-area-content">
            <div className="profile-wrap">
                ...
                <div className="profile-info">
                    <span className="profile-name">{this.state.username || 'Company'}</span>
                    <span className="country">Company Admin</span>
                </div>
            </div>
